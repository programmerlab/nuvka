...
use Modules\Website\Http\Requests\ProductRequest;
...
class ProductController extends Controller {
    ...
    {  
       ...
       // dd($cart);
        ...
        return view('website::checkout',compact('categories','products','category','cart','product_photo'));  
    }
    ...
    { 
        ...
        return view('website::order',compact('categories','products','category','cart','billing','shipping'));   
    ...
    public function showLoginForm(Request $request)
    {
        ...
        return view('website::login',compact('categories','products','category','cart'));
    ...
    public function showSignupForm(Request $request)
    {
        ...
        return view('website::register',compact('categories','products','category','cart'));
    ...
    {    
        ...
        return view('website::myaccount',compact('transaction','categories','products','category','cart','billing','shipping'));
