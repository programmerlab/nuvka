...
(function (root, factory) {
    ...
    function _initializeZoom() {
        var self = this,
			...
			plus = self.elements.plus = document.createElement('i');
			addClass(plus, 'fa');
			addClass(plus, 'fa-plus');
			addClass(plus, 'fa-1');
		
			minus = self.elements.plus = document.createElement('i');
			addClass(minus, 'fa');
			addClass(minus, 'fa-minus');
			addClass(minus, 'fa-1');
		
		addClass(wrap, 'cr-slider-wrap');
        addClass(zoomer, 'cr-slider');
        zoomer.type = 'range';
        zoomer.step = '0.000001';
		zoomer.max = '2';
		zoomer.min= '0.2604';
        zoomer.value = 1;
