...
(function($, window, document, undefined) {
    ...
    $.fn.imageuploadify = function(opts) {
        ...
        this.each(function() {
            ...
            let totalFiles = [];
            let counter = 0;
            let dragbox = $(`<div class="imageuploadify well"><div class="imageuploadify-overlay"><i class="fas fa-picture-o"></i></div><div class="imageuploadify-images-list text-center"><img src="`+ base_url+`/public/site/img/top-arrow.png" class="uploadIconfile"/><button type="button"class="btn btn-default"> select file to upload</button><br><span class='imageuploadify-message'>Drag&Drop Your File(s)Here To Upload</span><small>only .png .gif .jpg .jpeg and gif file with maximum size of 1MB is allowed</small></div></div>`);
            ...
            const readingFile = (id, file) => {
                ...
                let container = $(`<div class='imageuploadify-container'><button type='button'class='btn btn-danger '><span class="fa fa-close"></span><button><div class='imageuploadify-details'><span>${file.name}</span><span>${file.type}</span><span>${file.size}</span></div></div>`);
                ...
                if (file.type && file.type.search(/image/) != -1) {
                    ...
                    let type = "<i class='fas fa-file'></i>";
                    if (file.type.search(/audio/) != -1) {
                        type = "<i class='fas fa-file-audio-o'></i>";
                    } else if (file.type.search(/video/) != -1) {
                        type = "<i class='fas fa-file-video-o'></i>";
                    }
                    fReader.onloadend = function(e) {
