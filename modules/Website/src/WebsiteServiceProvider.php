...
class WebsiteServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
         ...
         */
        $this->loadViewsFrom(realpath(__DIR__ . '/../views'), 'website');

        // $modules = config("module.modules");
        if (method_exists($this, 'package')) {      
            $this->package('modules/Website', 'modules/Website', __DIR__ . '/..');
        } else {
            /*
    ...
    {
        $router->group(['namespace' => 'Modules\Website\Http\Controllers'], function ($router) {
